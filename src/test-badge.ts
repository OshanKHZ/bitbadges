...
async function test() {
  ...
  const testCases = [
    ...
    { text: 'Python', color: '#3776AB', logo: path.join(logosDir, 'python/python-no-outline.png') },
    { text: 'HTML', color: '#E34F26', logo: path.join(logosDir, 'html/html.png') },
    { text: 'Supabase', color: '#34b27b', logo: path.join(logosDir, 'supabase/supabase-black.png') },
    { text: 'Tailwind CSS', color: '#38bdf8', logo: path.join(logosDir, 'tailwind/tailwind-black.png') },
